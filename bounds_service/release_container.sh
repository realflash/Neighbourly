#!/usr/bin/env bash
# Neighbourly Bounds Service Release Pipeline
...
REGISTRY="registry.digitalocean.com/attono/neighbourly-bounds-service"
PROJECT_NAME="neighbourly-bounds-service"
