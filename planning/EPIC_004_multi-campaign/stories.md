...
The front end currenly has a dropdown which defaults to 'Warringah' indicating thar there is some sort of campaign system in place. We need to track the delivery of lealets as one campaign, and door knocking as another. We also want candidates in other wards to be able to use the tool fortheir own campaigns.  
...
- [ ] There is a drop down menu on the map page that allows me to select a campaign
